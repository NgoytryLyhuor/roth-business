...
export const ScrubInvoiceForm: React.FC<InvoiceFormProps> = ({ onPreview }) => {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-3 mb-3">
          <div className="flex justify-between items-center mb-3">
            ...
            <button onClick={addItem} className="flex items-center gap-1 px-2 py-1 bg-emerald-500 text-white rounded text-xs hover:bg-emerald-600">
              <Plus size={14} /> Add
            </button>
          </div>
